...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'sliders',
            'url'  => 'ru/admin/sliders',
            'icon' => 'fas fa-fw fa-images',
            'can' => 'manage-sliders',
        ],
        [
            'text' => 'banners',
            'url'  => 'ru/admin/banners',
            'icon' => 'fas fa-fw fa-list-alt',
            'can' => 'manage-banners',
        ],
        [
            'text' => 'posts',
            'url'  => 'ru/admin/blog/posts',
            'icon' => 'fas fa-fw fa-newspaper',
            'can' => 'manage-blog-posts',
        ],
        [
            'text' => 'videos',
            'url'  => 'ru/admin/blog/videos',
        ...
        [
            'text' => 'discounts',
            'url'  => 'ru/admin/discounts',
            'icon' => 'fas fa-fw fa-star',
            'can' => 'manage-discounts',
        ],
        [
            'text' => 'products',
            'url'  => 'ru/admin/shop/products',
            'icon' => 'fas fa-fw fa-box',
            'can' => 'manage-shop-products',
        ],
        [
            'text' => 'characteristic-groups',
            'url'  => 'ru/admin/shop/characteristic-groups',
            'icon' => 'fas fa-fw fa-file',
            'can' => 'manage-shop-characteristics',
        ],
        [
            'text' => 'characteristics',
            'url'  => 'ru/admin/shop/characteristics',
            'icon' => 'fas fa-fw fa-file',
            'can' => 'manage-shop-characteristics',
        ],
        [
        ...
        [
            'text' => 'categories',
            'url'  => 'ru/admin/categories',
            'icon' => 'fas fa-fw fa-list-alt',
            'can' => 'manage-categories',
        ],
        [
            'text' => 'marks',
            'url'  => 'ru/admin/shop/marks',
        ...
        [
            'text' => 'payments',
            'url'  => 'ru/admin/payments',
            'icon' => 'fas fa-fw fa-credit-card',
            'can' => 'manage-payments',
        ],
        [
            'text' => 'delivery_methods',
            'url'  => 'ru/admin/deliveries',
            'icon' => 'fas fa-fw fa-car',
            'can' => 'manage-deliveries',
        ],
        [
            'text' => 'carts',
            'url'  => 'ru/admin/shop/carts',
            'icon' => 'fas fa-fw fa-shopping-cart',
            'can' => 'manage-carts',
        ],
        [
            'text' => 'orders',
            'url'  => 'ru/admin/shop/orders',
            'icon' => 'fas fa-fw fa-list-alt',
            'can' => 'manage-orders',
        ],
    ],
