...
return [
    ...
    'female' => 'Женщина',
    'icon' => 'Иконка',
    'change_personal_info' => 'Изменить Персонал данные',
    'change_additional_info' => 'Изменить Личные данные',
    'personal_info' => 'Персонал данные',
    'additional_info' => 'Личные данные',
    'passport_info' => 'Парспортные данные',
    'cart_info' => 'Данные о карте',
    'user_cabinet' => 'Персональный кабинет',
    'verify_identity' => 'Подтвердите личность',
    'for_necessary_passport' => 'Необходимо, для осуществления покупок в рассрочку в будущем. Информация из паспорта и фото, должны быть читабельны',
    'foto_with_registration' => 'Фото паспорта с личными данными и прописки',
    'pres_for_upload' =>'Нажмите для загрузки',
    'upload_avatar' =>'Загрузите фото лица на фоне паспорта',
    ...
    'sliders' =>[
        'slider' => 'слайдер',
        'create new slider' => 'Создать новый слайдер',
        'sort' => 'Сортировать'
    ],
