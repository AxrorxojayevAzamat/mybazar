        ...
        <form action="get" class="accordion big-filter filter" id="catalogFilter">
            <div class="filter-item">
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <label  class="custom-control-label" for="customCheck1-1">Все телевизоры</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck1-2"  >
                    <label class="custom-control-label" for="customCheck1-2">Smart телевизоры</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck1-3" >
                    <label class="custom-control-label" for="customCheck1-3">4K UHD-телевизоры</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck1-4"  >
                    <label class="custom-control-label" for="customCheck1-4">8K UHD-телевизоры</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck1-5"  >
                    <label class="custom-control-label" for="customCheck1-5">QLED телевизоры</label>
                </div>
            </div>
            <div class="filter-item">
                ...
                <div  class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck2-1">10"-39"</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck2-2"  >
                    <label class="custom-control-label" for="customCheck2-2">40"-49"</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck2-3"  >
                    <label class="custom-control-label" for="customCheck2-3">50"-55"</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck2-4"  >
                    <label class="custom-control-label" for="customCheck2-4">56"-65"</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck2-5"  >
                    <label class="custom-control-label" for="customCheck2-5">66" и более</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck2-6"  >
                    <label class="custom-control-label" for="customCheck2-6">Телевизоры Samsung</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck2-7"  >
                    <label class="custom-control-label" for="customCheck2-7">Телевизоры LG</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck2-8"  >
                    <label class="custom-control-label" for="customCheck2-8"> Телевизоры Roison</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck2-9"  >
                    <label class="custom-control-label" for="customCheck2-9">Телевизоры Artel</label>
                </div>
            </div>
            <div class="filter-item">
                ...
                <div  class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck4-1">Спутниковое ТВ</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck4-2"  >
                    <label class="custom-control-label" for="customCheck4-2">Цифровое ТВ</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck4-3"  >
                    <label class="custom-control-label" for="customCheck4-3">Медиаплееры</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck4-4"  >
                    <label class="custom-control-label" for="customCheck4-4">ТВ-антенны</label>
                </div>
            </div>
            <div class="filter-item">
                ...
                <div  class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck5-1">Саундбары</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck5-2"  >
                    <label class="custom-control-label" for="customCheck5-2">Системы для вечеринок </label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck5-3"  >
                    <label class="custom-control-label" for="customCheck5-3">Музыкальные центры</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck5-4"  >
                    <label class="custom-control-label" for="customCheck5-4">DVD, Blu-Ray-плееры</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck5-5"  >
                    <label class="custom-control-label" for="customCheck5-5">Проекторы и экраны</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck5-6"  >
                    <label class="custom-control-label" for="customCheck5-6">Акустические системы</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck5-7"  >
                    <label class="custom-control-label" for="customCheck5-7">Ресиверы</label>
                </div>
                <div  class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="customCheck5-8"  >
                    <label class="custom-control-label" for="customCheck5-8">Проигрователи виниловых дисков и аксессуары</label>
                </div>
            </div>
        </form>
