<section>
    <div class="outter-single-product-with-des">
        <h4 class="title">Смартфон Redmi Note 9S (Interstellar Grey)</h4>
            ...
            <div class="description">
                <div class="text-description">
                    <div class="rate">
                        ...
                        <div class="comment">
                            <i class="mbcomment"></i>
                            <span>123 отзывов</span>
                        </div>
                    </div>
                    <p>ID товара: <span> 1666559495</span></p>
                    <p class="title">Характеристики</p>
                    <p>Диоганаль (дюйм):  <span> 6.67</span></p>
                    <p>Разрешение (пикс): <span> 2400х1080</span></p>
                    <p>Встроенная память  (Гб): <span> 64.128</span></p>
                    <p>Фотокамера: <span> 48 + 8 +5 +2 (четыре основные камеры)</span></p>
                    <p>Процессор: <span> Qualcomm Snapdragon 720G</span></p>
