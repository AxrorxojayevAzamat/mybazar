    ...
    <div class="item">
        ...
        <div class="description ">
            ...
            <div class="item-action-icons">
                <div class="cart" data-name="Телевизор Samsung QE55Q77RAU" data-url="{{asset('images/tv6.png')}}" data-price="741640"><i class="mbcart"></i>@lang('frontend.product.to_cart')</div>
