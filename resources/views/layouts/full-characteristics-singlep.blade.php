    ...
    <div class="accordion" id="fullCharacteristicsCollapse">
        <div class="card">
            ...
            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#fullCharacteristicsCollapse">
                <div class="card-body">
                    ...
                    <p class="grey">Размеры (В х Ш х Г)</p>
                    <p class="black">156.8 х 74.5 х 8.7 мм</p>
                    ...
                    <p class="black">4030 мАч, несъемный, Li-Pro</p>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-header" id="headingTwo">
                <h2 class="mb-0">
                    <button class="btn" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                        Производительность  и комплектующие
                    </button>
                </h2>
            </div>
        ...
        <div class="card">
            <div class="card-header" id="headingSix">
                <h2 class="mb-0">
                    <button class="btn" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseFix">
                    Музыка и аудио 
                    </button>
                </h2>
            </div>
        ...
        <div class="card">
            <div class="card-header" id="headingSeven">
                <h2 class="mb-0">
                    <button class="btn" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
                    Другие осоьенности
                    </button>
                </h2>
            </div>
