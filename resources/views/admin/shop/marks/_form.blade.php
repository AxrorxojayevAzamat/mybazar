        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    {!! Form::text('name_uz', old('name_uz', $mark ? $mark->name_uz : null), ['class'=>'form-control' . ($errors->has('name_uz') ? ' is-invalid' : ''), 'required' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('name_ru', old('name_ru', $mark ? $mark->name_ru : null), ['class'=>'form-control' . ($errors->has('name_ru') ? ' is-invalid' : ''), 'required' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('name_en', old('name_en', $mark ? $mark->name_en : null), ['class'=>'form-control' . ($errors->has('name_en') ? ' is-invalid' : ''), 'required' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('slug', old('name_en', $mark ? $mark->slug : null), ['class'=>'form-control' . ($errors->has('slug') ? ' is-invalid' : ''), 'required' => true]) !!}
                    @if ($errors->has('slug'))
...
<div class="form-group">
    <button type="submit" class="btn btn-primary">{{ trans('adminlte.' . ($mark ? 'edit' : 'save')) }}</button>
</div>
...
{{--    <script src="{{ mix('js/fileinput.js', 'build') }}"></script>--}}
    ...
    <script>
        ...
        let logoUrl = '{{ $mark ? ($mark->photo ? $mark->photoOriginal : null) : null }}';
