            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane active" id="uzbek" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('body_uz', old('body_uz', $news ? $news->body_uz : null),
                    ...
                    <div class="tab-pane" id="russian" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('body_ru', old('body_ru', $news ? $news->body_ru : null),
                    ...
                    <div class="tab-pane" id="english" role="tabpanel">
                        <div class="form-group">
                            ...
                            {!! Form::text('title_en', old('title_en', $news ? $news->title_en : null), ['class'=>'form-control' . ($errors->has('title_en') ? ' is-invalid' : ''), 'required' => true]) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('description_en', old('description_en', $news ? $news->description_en : null),
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('body_en', old('body_en', $news ? $news->body_en : null),
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        {!! Form::select('category_id', $categories, old('category_id', $news ? $news->category_id : null),
                ...
                <div class="col-md-10">
                    <div class="form-group{{ $errors->has('is_published') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('is_published', [1 => 'On', 2 => 'Off'], old('category_id', $news ? $news->is_published : null),
...
<div class="form-group">
    <button type="submit" class="btn btn-primary">{{ trans('adminlte.' . ($news ? 'edit' : 'save')) }}</button>
</div>
...
@section($javaScriptSectionName)
    ...
    <script>
        ...
        let fileUrl = '{{ $news ? ($news->file ? $news->fileOriginal : null) : null }}';
