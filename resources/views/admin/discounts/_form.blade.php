    ...
    <div class="col-md-12">
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        {!! Form::label('start_date', trans('adminlte.date_from'), ['class' => 'col-form-label']); !!}
                        {!! Form::date('start_date', old('start_date', $discount && $discount->start_date ? date($discount->start_date) : null),
                        ...
                        @endif
                                ...
                                <div class="col-md-10">
                    <div class="form-group">
                        {!! Form::label('end_date', trans('adminlte.date_to'), ['class' => 'col-form-label']); !!}
                        {!! Form::date('end_date', old('end_date', $discount && $discount->end_date ? date($discount->end_date) : null),
                ...
                <div class="col-md-10">
                    <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('status', $statuses, old('status', $discount ? $discount->status : null),
...
<div class="form-group">
    <button type="submit" class="btn btn-primary">{{ trans('adminlte.' . ($discount ? 'edit' : 'save')) }}</button>
</div>
