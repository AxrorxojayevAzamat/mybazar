...
<div class="card card-green card-outline">
    <div class="card-body">
        <div class="form-group{{ $errors->has('poster') ? ' has-error' : '' }}">
            {!! Form::label('poster', 'Poster', ['class' => 'col-md-2 control-label']) !!}

            <div class="col-md-8">
                {!! Form::file('poster', ['accept' => '.jpg,.png', 'required',  'class' => 'form-control hidden', 'id'=>'poster']) !!}
        ...
        <div class="form-group{{ $errors->has('video') ? ' has-error' : '' }}">
            ...
            <div class="col-md-8">
                {!! Form::file('video', ['accept' => '.mp4', 'required',  'class' => 'form-control hidden', 'id'=>'video']) !!}
