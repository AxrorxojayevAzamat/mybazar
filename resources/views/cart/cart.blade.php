    ...
    <section>
        ...
        <div class="outter-cart">
            <div class="ur-cart">
                ...
                <p class="first"> @lang('frontend.cart.in_cart')<span> 2 @lang('frontend.cart.items').</span></p>
            ...
            <div class="inner-pay-checkout-cart">
                <button class="clear-list">@lang('frontend.cart.clear_list')</button>
                <div class="all-items">
                    <div class="item">
                        ...
                        <div class="description ">
                            <h6 class="title">@lang('frontend.cart.tv') Samsung QE55Q77RAU</h6>
                            <p class="sub-title">@lang('frontend.cart.tvs')</p>
                            <div class="current-old-price horizontal">
                                <h5 class="price">741 640 <span>@lang('frontend.cart.sum')</span></h5>
