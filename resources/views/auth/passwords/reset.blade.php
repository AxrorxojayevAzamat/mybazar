        ...
        <div class="row justify-content-center">
            <div class="col-md-10 reset">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="email_or_phone"
                                   ...
                                   name="email_or_phone" value="{{ $emailOrPhone ?? old('email_or_phone') }}" required
                                   disabled autocomplete="email_or_phone" autofocus>
                    ...
                    @if ($isPhone)
                        <div class="form-group row">
                            <label for="email-or-phone-token"
                                   class="col-md-4 col-form-label text-md-right">@lang('auth.sms_code')</label>
                            <div class="col-md-6">
                                <input id="email-or-phone-token" type="text" name="token"
