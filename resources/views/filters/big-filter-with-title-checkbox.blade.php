<form action="#" class="big-filter-with-title-checkbox">
    ...
    <div class="filter-item custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input checkAll" id="smallcustomCheck2-0">
        <label  class="custom-control-label checkAll-first-label" for="smallcustomCheck2-0"></label>
        <button type="button" class="btn checkAll-label  active "  >Бренд</button>
    ...
    <div class="filter-item custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input checkAll" id="smallcustomCheck4-0">
        <label  class="custom-control-label checkAll-first-label" for="smallcustomCheck4-0"></label>
        <button type="button" class="btn checkAll-label  active "  >Диоганаль</button>
    ...
    <div class="filter-item custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input checkAll" id="smallcustomCheck5-0">
        <label  class="custom-control-label checkAll-first-label" for="smallcustomCheck5-0"></label>
        <button type="button" class="btn checkAll-label  active">Функции</button>
